...
function agregarAlCarrito(productId) {
    ...
    if (producto) {
        ...
        console.log(`Agregado al carrito: ${producto.nombre} por $${producto.precio}`);
    } else {
...
function main() {
    let continuar = true;
    while (continuar) {
        const accion = prompt("Ingrese acción (agregar, eliminar, verCarrito, verTotal, salir):");
        switch (accion) {
            case "agregar":
                ...
                break;
            case "eliminar":
                const idEliminar = parseInt(prompt("Ingrese ID del producto a eliminar del carrito"));
